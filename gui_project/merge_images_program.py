...
from tkinter import filedialog # 서브 모듈이기 때문에 따로 import
...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요.", \
        ...
        initialdir="/Users/parkheondo/Desktop/") # 최초에 User/parkheondo/Desktop/ 경로를 보여줌
...
def merge_image():
    ...
    try:
        ...
        img_sizes = [] # [(width1, height1), (width2, height2), (width3, height3), ...]
        if img_width > -1:
        ...
        # y' = x'y / x = img_width * size[0] / size[1]    
    ...
    # 포맷 옵션 처리
        file_name = "heondo_photo." + img_format
